...
- Windows - `cd desktop ; wget https://nekobin.com/raw/ultroid-termux -o locals.py ; python locals.py`
- Termux - `sh -c "$(curl -fsSL https://nekobin.com/raw/ultroid-termux-deploy)"`
...
- Generate your `SESSION`:
  - For Linux users:
    `bash sessiongen`
     or
    `bash -c "$(curl -fsSL https://nekobin.com/ultroid)"`
  - For Termux users:
    `sh -c "$(curl -fsSL https://da.gd/termux-tel)"`
  - For Windows Users:
    `cd desktop ; wget https://nekobin.com/ultroid -o ultroid.py ; python ultroid.py`
...
* Linux : `bash -c "$(curl -fsSL https://nekobin.com/ultroid)"`
